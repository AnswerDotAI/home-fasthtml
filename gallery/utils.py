...
def get_social_links(dir_path):
    ...
    return Socials(title=meta['ComponentName'], description=meta['ComponentDescription'], site_name='fastht.ml/gallery', twitter_site='@isaac_flath', image=f"/files/{dir_path/'card_thumbnail.png'}", url='')

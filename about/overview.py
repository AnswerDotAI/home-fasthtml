...
The site you're reading right now provides background information about the key concepts and ideas behind FastHTML. The [documentation](https://answerdotai.github.io/fasthtml) focuses on the code. Because FastHTML brings together many different web technologies, it's worth investing some time to understand how it all fits together. Have a look through the five sections in the green navbar (or hamburger menu if you're on mobile) above to deepen your understanding. As legendary Python coder and "Two Scoops of Django" co-author Audrey Roy Greenfeld told us:
